...
test_barb1 = character.Character(char_class="Barbarian", level=1, stg=17, dex=13, con=14, inl=10, wis=12, cha=8,
                                 feat_list=["Cleave", "Power Attack"], name="Arjana", loc=[5, 5], hp=12, fc=["h"],
                                 side=2)
...
print("{} ({} {}):".format(fighter1.name, fighter1.char_class, fighter1.level))
print("\t{}".format(fighter1.print_ac_line()))
print("\t{}".format(fighter1.print_save_line()))
print("\t{}".format(fighter1.print_all_atks()))
print("\n\n")
print("{} ({} {}):".format(fighter2.name, fighter2.char_class, fighter2.level))
...
print("=====================================================================================")
print(fight.output_log())
print(fighter1.get_atk_bon(0, True, fighter2.type_mon, fighter2.subtype))
...
for ftr_id in fighter1.ai.mental_model:
    print("{} Model: {}".format(fighter1.name, ftr_id))
    print("\t{}".format(fighter1.ai.mental_model[ftr_id].name))
print("=====================================================================================")
print(fighter2.get_atk_bon(0, True, fighter1.type_mon, fighter1.subtype))
...
for ftr_id in fighter1.ai.mental_model:
    print("{} Model: {}".format(fighter2.name, ftr_id))
    print("\t{}".format(fighter2.ai.mental_model[ftr_id].name))
